        ...
        <form id="regform" runat="server">
            ...
            <div style="padding-top: 20px; margin-left: 40px;" class="row">
                ...
                <div align="center" class="col">
                    <div class="form-group row">
                        <div class="col-10">
                            <asp:Button ID="addButton" runat="server" OnClientClick="addNonExistingClass()" class="btn btn-secondary btn-lg active" Text="Add"></asp:Button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <asp:Button runat="server" class="btn btn-secondary btn-lg active" OnClientClick="AddClassChange()" text="Add"></asp:Button>
                        </span>
                    </div>
                    <!-- /input-group -->
                </div>
